...
class QrNoActionScreen extends StatelessWidget {
  const QrNoActionScreen({Key? key}) : super(key: key);
      ...
      content: Column(
        ...
        children: [
          ...
          StatusMessageCard(
            ...
            message: 'Check here if you see Action Needed message',
            backgroundColor:
                Colors.grey[300], // Adjust color to match your image
            textColor: Colors.black87,
          ),
          const SizedBox(height: 20), // Spacing before the action button
        ],
      ),
      actionButtonText: 'Action', // Text for the bottom action button
      onActionButtonPressed: () {
        // Handle action button press
        print('Action button pressed!');
      },
      customButtonColor: Colors.grey[300], // Use your primary color
